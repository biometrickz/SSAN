...
#         if train:
#             if (data_name == "PADDED"):
#                 data_dir = os.path.join(data_dir, "train/1_300x300/")
#             elif (data_name == "JOINED"):
#                 data_dir = os.path.join(data_dir, "train/")
#             if data_name in self.datasets:
#                 data_set = Spoofing_custom(os.path.join(data_dir, "live/train_list.csv"), os.path.join(data_dir, "live"), depth_dir, transform=transform, img_size=img_size, map_size=map_size, UUID=UUID)
#                 data_set += Spoofing_custom(os.path.join(data_dir, "spoof/train_list.csv"), os.path.join(data_dir, "spoof"), depth_dir, transform=transform, img_size=img_size, map_size=map_size, UUID=UUID)
#             else:
...
#         else:
#             if (data_name == "PADDED"):
#                 data_dir = os.path.join(data_dir, "val/1_300x300/")
#             elif (data_name == "JOINED"):
#                 data_dir = os.path.join(data_dir, "val/")
#             if data_name in self.datasets:
#                 data_set = Spoofing_custom(os.path.join(data_dir, "live/val_list.csv"), os.path.join(data_dir, "live"), depth_dir, transform=transform, img_size=img_size, map_size=map_size, UUID=UUID)
#                 data_set += Spoofing_custom(os.path.join(data_dir, "spoof/val_list.csv"), os.path.join(data_dir, "spoof"), depth_dir, transform=transform, img_size=img_size, map_size=map_size, UUID=UUID)
#             else:
#                 print("NO DATASET Found")
#                 exit() 
#             if debug_subset_size is not None:
...
#         elif protocol == "D123toD12":
#             data_name_list_train = ["INSIGHTFACE", "PADDED", "JOINED"]
#             data_name_list_test = ["PADDED", "JOINED"]
#         else:
